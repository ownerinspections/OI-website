...
export default async function ExpertWitnessReportBookingStep({ searchParams }: { searchParams?: Promise<Record<string, string | string[]>> }) {
    ...
    return (
        <div className="container">
            <div className="card">
                <FormHeader 
                    rightTitle="Booking" 
                    rightSubtitle="Expert Witness Report Inspection"
                ...
                <div style={{ display: "grid", gap: 16 }}>
                    ...
                    <div style={{ textAlign: "center", marginBottom: 8 }}>
                        <div style={{ color: "var(--color-text-primary)", fontSize: 18, fontWeight: 700 }}>{serviceName || "Expert Witness Report Inspection"}</div>
                    </div>
                    ...
                    {/* Read-only booking details - only show if NOT editable */}
                    {!isEditable && (
                        <div>
                            ...
                            <div style={{ display: "grid", gap: 12, marginBottom: 16, marginTop: 24 }}>
                                ...
                                <div style={{ gridColumn: "1 / -1" }}>
                                    <div style={{ fontSize: 12, color: "var(--color-text-muted)", marginBottom: 4 }}>Application process</div>
                                    <div style={{ color: "var(--color-text-primary)" }}>
                                        {(() => {
                                            const applicationProcess = (booking as any)?.application_process;
                                            if (!applicationProcess) return "—";
                                            
                                            switch (applicationProcess) {
                                                case "nothing_lodged_yet": return "Nothing lodged yet";
                                                case "in_mediation": return "In mediation";
                                                case "at_tribunal": return "At tribunal";
                                                case "in_court": return "In court";
                                                default: return applicationProcess;
                                            }
                                        })()}
                                    </div>
                                </div>
