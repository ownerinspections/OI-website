            ...
            <div className="card">
                ...
                <div style={{ display: "grid", gap: 16 }}>
                    ...
                    <div style={{ textAlign: "center", marginBottom: 8 }}>
                        <div style={{ color: "var(--color-text-primary)", fontSize: 18, fontWeight: 700 }}>{serviceName || "Pre-Purchase Inspection"}</div>
                    </div>
                    ...
                    {/* Real Estate URL fields for each property - only when editable */}
                    {isEditable && propertiesExpanded.length > 0 && (
                        <div>
                            <div style={{ fontWeight: 600, marginBottom: 4, fontSize: 14, color: "var(--color-text-secondary)" }}>Property Real Estate Links</div>
                            <div style={{ display: "grid", gap: 16 }}>
                                {propertiesExpanded.map((property: any, index: number) => {
                                    const realestateUrl = property?.realestate_url;
                                    return (
                                        <div key={String(property?.id || index)}>
                                            ...
                                            <div style={{ 
                                                ...
                                                <input
                                                    type="url"
                                                    name={`property_${property?.id}_realestate_url`}
                                                    defaultValue={realestateUrl || ""}
