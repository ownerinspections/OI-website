            ...
            <div className="card">
                ...
                <div style={{ display: "grid", gap: 16 }}>
                    ...
                    <div style={{ textAlign: "center", marginBottom: 8 }}>
                        <div style={{ color: "var(--color-text-primary)", fontSize: 18, fontWeight: 700 }}>{serviceName || "Construction Stages Inspection"}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style={{ display: "grid", gap: 16, color: "var(--color-text-secondary)", fontSize: 14 }}>
                            ...
                            {propertiesExpanded.map((p: any, index: number) => {
                                ...
                                pushDetail("Size", p?.area_sq || p?.size_sq || p?.property_size || p?.size || p?.land_size || p?.building_size);
                                
                                // Format levels as storey description
                                const levelsValue = p?.number_of_levels || p?.levels || p?.storeys;
                                let levelsDisplay = "—";
                                if (levelsValue) {
                                    const numLevels = parseInt(String(levelsValue));
                                    if (numLevels === 1) levelsDisplay = "Single storey";
                                    else if (numLevels === 2) levelsDisplay = "Double storey";
                                    else if (numLevels === 3) levelsDisplay = "Triple storey";
                                    else levelsDisplay = String(levelsValue);
                                }
                                pushDetail("Levels", levelsDisplay);
                                ...
                                const leftItems: ItemType[] = [
                                    ...
                                    details.find(d => d.label === "Size") || { label: "Size", value: "—" }
                                ];
                    ...
                    {isEditable && (
                        <BookingForm
                            ...
                            quoteId={quoteId}
                            invoiceId={invoiceId}
                            inspection_type="construction_stages"
