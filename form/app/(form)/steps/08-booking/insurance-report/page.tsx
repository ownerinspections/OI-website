...
export default async function InsuranceReportBookingStep({ searchParams }: { searchParams?: Promise<Record<string, string | string[]>> }) {
            ...
            <div className="card">
                ...
                <div style={{ display: "grid", gap: 16 }}>
                    ...
                    <div style={{ textAlign: "center", marginBottom: 8 }}>
                        <div style={{ color: "var(--color-text-primary)", fontSize: 18, fontWeight: 700 }}>{serviceName || "Insurance Report Inspection"}</div>
                    </div>
                    ...
                    {isEditable && (
                        <BookingForm
                            ...
                            quoteId={quoteId}
                            invoiceId={invoiceId}
                            inspection_type="insurance_report"
