...
export default async function DilapidationBookingStep({ searchParams }: { searchParams?: Promise<Record<string, string | string[]>> }) {
                ...
                <div style={{ display: "grid", gap: 16 }}>
                    ...
                    <div className="booking-details-section">
                        ...
                        <div>
                            ...
                            <div style={{ color: "var(--color-text-secondary)", fontSize: 14 }}>{serviceName || "Dilapidation Inspection"}</div>
                        </div>
